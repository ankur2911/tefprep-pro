...
// @ts-expect-error — getReactNativePersistence is exported by the RN entry but not in the web types bundle
...
// Use AsyncStorage persistence so sign-in survives app restarts (RN default loses it)
